SOURCES=atmost2maxsubstr.cpp balance.cpp compareBinHex.cpp isSorted.cpp maxpalindrome.cpp \
        ...
        nqueens.cpp 3sum.cpp mergeKSortedList.cpp inplacemergesortvector.cpp rainwater.cpp maxSubstringAll.cpp \
        listPalindrome.cpp stringPalindrome.cpp bfstree.cpp
